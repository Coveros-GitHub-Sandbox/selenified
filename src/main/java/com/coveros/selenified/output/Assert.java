...
public class Assert {
	...
	private int compareResponseData(Response response, JsonObject expectedResponseData) {
		Success success = response.getData().equals(expectedResponseData) ? Success.PASS : Success.FAIL;
		outputFile.recordExpected("Expected to find a response of:" + outputFile.formatJSON(expectedResponseData));
