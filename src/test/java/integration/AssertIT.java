...
public class AssertIT extends WebBase {
    ...
    @Test(groups = {"integration", "assert", "alert", "no-safari"},
    ...
    // skipping safari as it doesn't support modal dialogs: https://github.com/SeleniumHQ/selenium-google-code-issue-archive/issues/3862
    @Test(groups = {"integration", "assert", "alert", "no-safari"}, description = "An integration test to check the checkAlert method")
    ...
    // skipping safari as it doesn't support modal dialogs: https://github.com/SeleniumHQ/selenium-google-code-issue-archive/issues/3862
    @Test(groups = {"integration", "assert", "alert", "no-safari"}, description = "An integration test to check the checkPrompt method")
