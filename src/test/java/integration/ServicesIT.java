...
public class ServicesIT extends TestBase {
    ...
    public void compareGetParamsResponseObjectDataTest() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.compareGetResponseData("posts/1", new Request(params), response);
        // verify no issues
        finish();
    }
    ...
    @Test(groups = { "integration", "services", "put",
    ...
    public void comparePutResponseCode200Test() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.comparePutResponseCode("posts/1", new Request(request), 200);
        // verify no issues
        finish();
    }
    ...
    public void comparePutResponseBadCode201Test() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.comparePutResponseCode("posts/1", new Request(request), 201);
        // verify one issue
        finish(1);
    }
    ...
    public void comparePutResponseDataTest() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.comparePutResponseData("posts/1", new Request(request), request);
        // verify no issues
        finish();
    }
    ...
    public void comparePutResponseBadDataTest() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.comparePutResponseData("posts/1", new Request(request), response);
        // verify one issue
        finish(1);
    }

    @Test(groups = { "integration", "services", "patch",
    ...
    public void comparePatchResponseCode200Test() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.comparePatchResponseCode("posts/1", new Request(request), 200);
        // verify no issues
        finish();
    }
    ...
    public void comparePatchResponseBadCode201Test() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.comparePatchResponseCode("posts/1", new Request(request), 201);
        // verify one issue
        finish(1);
    }
    ...
    public void comparePatchResponseDataTest() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.comparePatchResponseData("posts/1", new Request(request), request);
        // verify no issues
        finish();
    }
    ...
    public void comparePatchResponseBadDataTest() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.comparePatchResponseData("posts/1", new Request(request), response);
        // verify one issue
        finish(1);
    }
}