...
public class ServicesIT extends TestBase {
    ...
    public void compareGetResponseBadCode201Test() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().get("posts/").assertEquals(201);
        // verify one issue
        finish(1);
    }
    ...
    public void compareGetResponseCode404Test() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().get("post/").assertEquals(404);
        // verify no issues
        finish();
    }
    ...
    public void compareGetResponseBadCode400Test() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().get("post/").assertEquals(400);
        // verify one issue
        finish(1);
    }
    ...
    public void compareGetParamsResponseCode200Test() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().get("posts/", new Request(params)).assertEquals(200);
        // verify no issues
        finish();
    }
    ...
    public void compareGetParamsResponseCode404Test() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().get("post/", new Request(params)).assertEquals(404);
        // verify no issues
        finish();
    }
    ...
    public void compareGetParamsResponseBadCode400Test() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().get("post/", new Request(params)).assertEquals(400);
        // verify one issue
        finish(1);
    }
    ...
    public void checkGetResponseContainsSingleObjectDataTest() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().get("posts/6").assertContains(responsePairs);
        // verify no issues
        finish();
    }
    ...
    public void checkGetResponseContainsArrayDataTest() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().get("posts").assertContains(json);
        // verify no issues
        finish();
    }
    ...
    public void compareGetResponseObjectDataTest() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().get("posts/6").assertEquals(response);
        // verify no issues
        finish();
    }
    ...
    public void compareGetResponseArrayDataTest() {
        ...
        response = (JsonArray) parser.parse(
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().get("posts").assertEquals(response);
        // verify no issues
        finish();
    }
    ...
    public void checkGetParamsResponseContainsSingleObjectDataTest() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().get("posts/6", new Request(params)).assertContains(responsePairs);
        // verify no issues
        finish();
    }
    ...
    public void checkGetParamsResponseContainsArrayDataTest() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().get("posts", new Request(params)).assertContains(json);
        // verify no issues
        finish();
    }
    ...
    public void compareGetParamsResponseObjectDataTest() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().get("posts/6", new Request(params)).assertEquals(response);
        // verify no issues
        finish();
    }
    ...
    public void compareGetParamsResponseArrayDataTest() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().get("posts", new Request(params)).assertEquals(response);
        // verify no issues
        finish();
    }
    ...
    public void comparePostResponseCode404Test() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().post("post/", new Request(request)).assertEquals(404);
        // verify no issues
        finish();
    }
    ...
    public void comparePostResponseBadCode400Test() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().post("post/", new Request(request)).assertEquals(400);
        // verify one issue
        finish(1);
    }
    ...
    public void checkPostResponseContainsSingleDataTest() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().post("posts/", new Request(request)).assertContains(responsePairs);
        // verify no issues
        finish();
    }
    ...
    public void comparePostResponseDataTest() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().post("posts/", new Request(request)).assertEquals(response);
        // verify no issues
        finish();
    }
    ...
    public void comparePutResponseCode404Test() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().put("post/", new Request(request)).assertEquals(404);
        // verify no issues
        finish();
    }
    ...
    public void comparePutResponseBadCode400Test() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().put("post/", new Request(request)).assertEquals(400);
        // verify one issue
        finish(1);
    }
    ...
    public void checkPutResponseContainsSingleDataTest() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().put("posts/3", new Request(request)).assertContains(responsePairs);
        // verify no issues
        finish();
    }
    ...
    public void comparePutResponseDataTest() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().put("posts/3", new Request(request)).assertEquals(request);
        // verify no issues
        finish();
    }
    ...
    public void comparePutResponseBadDataTest() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().put("posts/3", new Request(request)).assertEquals(response);
        // verify one issue
        finish(1);
    }
    ...
    public void comparePatchResponseCode404Test() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().patch("post/", new Request(request)).assertEquals(404);
        // verify no issues
        finish();
    }
    ...
    public void comparePatchResponseBadCode400Test() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().patch("post/", new Request(request)).assertEquals(400);
        // verify one issue
        finish(1);
    }
    ...
    public void checkPatchResponseContainsSingleDataTest() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().patch("posts/4", new Request(request)).assertContains(responsePairs);
        // verify no issues
        finish();
    }
    ...
    public void comparePatchResponseDataTest() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().patch("posts/4", new Request(request)).assertEquals(request);
        // verify no issues
        finish();
    }
    ...
    public void comparePatchResponseBadDataTest() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().patch("posts/4", new Request(request)).assertEquals(response);
        // verify one issue
        finish(1);
    }
    ...
    public void compareDeleteResponseCode404Test() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().delete("post/", new Request(request)).assertEquals(404);
        // verify no issues
        finish();
    }
    ...
    public void compareDeleteResponseBadCode400Test() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().delete("post/", new Request(request)).assertEquals(400);
        // verify one issue
        finish(1);
    }
    ...
    public void compareDeleteResponseDataTest() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().delete("posts/5", new Request(request)).assertEquals(new JsonObject());
        // verify no issues
        finish();
    }
    ...
    public void compareDeleteResponseBadDataTest() {
        ...
        Action actions = this.actions.get();
        // perform some actions
        actions.call().delete("posts/5", new Request(request)).assertEquals(response);
        // verify one issue
        finish(1);
    }
}