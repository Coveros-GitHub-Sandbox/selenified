...
public class ServicesIT extends Selenified {
    ...
    @Test(groups = {"integration", "services", "httpget"},
            description = "A negative integration test to verify the response code from a get call")
    ...
    public void compareGetResponseBadCode400Test() {
        ...
        Call call = this.calls.get();
        // perform some actions
        call.get("post/").assertEquals(400);
        // verify one issue
        finish(1);
    }
    ...
    public void compareGetParamsResponseCode404Test() {
        ...
        Call call = this.calls.get();
        // perform some actions
        call.get("post/", new Request(params)).assertEquals(404);
        // verify no issues
        finish();
    }
    ...
    public void compareGetParamsResponseBadCode400Test() {
        ...
        Call call = this.calls.get();
        // perform some actions
        call.get("post/", new Request(params)).assertEquals(400);
        // verify one issue
        finish(1);
    }

    @Test(groups = {"integration", "services", "httpget"},
            description = "An integration test to verify the data from a get call")
    ...
    public void compareGetResponseObjectDataTest() {
        ...
        response.addProperty("id", 6);
        response.addProperty("title", "dolorem eum magni eos aperiam quia");
        response.addProperty("body",
                "ut aspernatur corporis harum nihil quis provident sequi\nmollitia nobis aliquid molestiae\nperspiciatis et ea nemo ab reprehenderit accusantium quas\nvoluptate dolores velit et doloremque molestiae");
        // use this object to verify the app looks as expected
        Call call = this.calls.get();
        // perform some actions
        call.get("posts/6").assertEquals(response);
        // verify no issues
        finish();
    }
    ...
    public void compareGetParamsResponseArrayDataTest() {
        ...
        JsonParser parser = new JsonParser();
        JsonArray response = (JsonArray) parser
                .parse("[ { \"userId\": 6, \"id\": 51, \"title\": \"soluta aliquam aperiam consequatur illo quis voluptas\", \"body\": \"sunt dolores aut doloribus\ndolore doloribus voluptates tempora et\ndoloremque et quo\ncum asperiores sit consectetur dolorem\" }, { \"userId\": 6, \"id\": 52, \"title\": \"qui enim et consequuntur quia animi quis voluptate quibusdam\", \"body\": \"iusto est quibusdam fuga quas quaerat molestias\na enim ut sit accusamus enim\ntemporibus iusto accusantium provident architecto\nsoluta esse reprehenderit qui laborum\" }, { \"userId\": 6, \"id\": 53, \"title\": \"ut quo aut ducimus alias\", \"body\": \"minima harum praesentium eum rerum illo dolore\nquasi exercitationem rerum nam\nporro quis neque quo\nconsequatur minus dolor quidem veritatis sunt non explicabo similique\" }, { \"userId\": 6, \"id\": 54, \"title\": \"sit asperiores ipsam eveniet odio non quia\", \"body\": \"totam corporis dignissimos\nvitae dolorem ut occaecati accusamus\nex velit deserunt\net exercitationem vero incidunt corrupti mollitia\" }, { \"userId\": 6, \"id\": 55, \"title\": \"sit vel voluptatem et non libero\", \"body\": \"debitis excepturi ea perferendis harum libero optio\neos accusamus cum fuga ut sapiente repudiandae\net ut incidunt omnis molestiae\nnihil ut eum odit\" }, { \"userId\": 6, \"id\": 56, \"title\": \"qui et at rerum necessitatibus\", \"body\": \"aut est omnis dolores\nneque rerum quod ea rerum velit pariatur beatae excepturi\net provident voluptas corrupti\ncorporis harum reprehenderit dolores eligendi\" }, { \"userId\": 6, \"id\": 57, \"title\": \"sed ab est est\", \"body\": \"at pariatur consequuntur earum quidem\nquo est laudantium soluta voluptatem\nqui ullam et est\net cum voluptas voluptatum repellat est\" }, { \"userId\": 6, \"id\": 58, \"title\": \"voluptatum itaque dolores nisi et quasi\", \"body\": \"veniam voluptatum quae adipisci id\net id quia eos ad et dolorem\naliquam quo nisi sunt eos impedit error\nad similique veniam\" }, { \"userId\": 6, \"id\": 59, \"title\": \"qui commodi dolor at maiores et quis id accusantium\", \"body\": \"perspiciatis et quam ea autem temporibus non voluptatibus qui\nbeatae a earum officia nesciunt dolores suscipit voluptas et\nanimi doloribus cum rerum quas et magni\net hic ut ut commodi expedita sunt\" }, { \"userId\": 6, \"id\": 60, \"title\": \"consequatur placeat omnis quisquam quia reprehenderit fugit veritatis facere\", \"body\": \"asperiores sunt ab assumenda cumque modi velit\nqui esse omnis\nvoluptate et fuga perferendis voluptas\nillo ratione amet aut et omnis\" }]");
        // use this object to verify the app looks as expected
        Call call = this.calls.get();
        // perform some actions
        call.get("posts", new Request(params)).assertEquals(response);
        // verify no issues
        finish();
    }
    ...
    @Test(groups = {"integration", "services", "httppost"},
            description = "A negative integration test to verify the response code from a post call")
    ...
    public void comparePostResponseCode404Test() {
        ...
        Call call = this.calls.get();
        // perform some actions
        call.post("post/", new Request(request)).assertEquals(404);
        // verify no issues
        finish();
    }
    ...
    public void comparePostResponseBadCode400Test() {
        ...
        Call call = this.calls.get();
        // perform some actions
        call.post("post/", new Request(request)).assertEquals(400);
        // verify one issue
        finish(1);
    }

    @Test(groups = {"integration", "services", "httppost"},
            description = "An integration test to verify the data from a post call")
    public void checkPostResponseContainsSingleDataTest() {
        ...
        Call call = this.calls.get();
        // perform some actions
        call.post("posts/", new Request(request)).assertContains(responsePairs);
        // verify no issues
        finish();
    }
    ...
    @Test(groups = {"integration", "services", "httppost"},
            description = "A negative integration test to verify the data from a post call")
    ...
    @Test(groups = {"integration", "services", "httpput"},
            description = "A negative integration test to verify the response code from a put call")
    ...
    public void comparePutResponseCode404Test() {
        ...
        Call call = this.calls.get();
        // perform some actions
        call.put("post/", new Request(request)).assertEquals(404);
        // verify no issues
        finish();
    }
    ...
    public void comparePutResponseBadCode400Test() {
        ...
        Call call = this.calls.get();
        // perform some actions
        call.put("post/", new Request(request)).assertEquals(400);
        // verify one issue
        finish(1);
    }

    @Test(groups = {"integration", "services", "httpput"},
            description = "An integration test to verify the data from a put call")
    ...
    public void comparePutResponseDataTest() {
        ...
        Call call = this.calls.get();
        // perform some actions
        call.put("posts/3", new Request(request)).assertEquals(request);
        // verify no issues
        finish();
    }

    @Test(groups = {"integration", "services", "httpput"},
            description = "A negative integration test to verify the data from a put call")
    ...
    @Test(groups = {"integration", "services", "httppatch"},
            description = "A negative integration test to verify the response code from a patch call")
    ...
    public void comparePatchResponseCode404Test() {
        ...
        Call call = this.calls.get();
        // perform some actions
        call.patch("post/", new Request(request)).assertEquals(404);
        // verify no issues
        finish();
    }
    ...
    public void comparePatchResponseBadCode400Test() {
        ...
        Call call = this.calls.get();
        // perform some actions
        call.patch("post/", new Request(request)).assertEquals(400);
        // verify one issue
        finish(1);
    }

    @Test(groups = {"integration", "services", "httppatch"},
            description = "An integration test to verify the data from a patch call")
    ...
    @Test(groups = {"integration", "services", "httppatch"},
            description = "A negative integration test to verify the data from a patch call")
    ...
    @Test(groups = {"integration", "services", "httpdelete"},
            description = "A negative integration test to verify the response code from a delete call")
    ...
    public void compareDeleteResponseBadCode400Test() {
        ...
        Call call = this.calls.get();
        // perform some actions
        call.delete("post/", new Request(request)).assertEquals(400);
        // verify one issue
        finish(1);
    }

    @Test(groups = {"integration", "services", "delete"},
            description = "An integration test to verify the data from a delete call")
    ...
    @Test(groups = {"integration", "services", "httpdelete"},
            description = "A negative integration test to verify the data from a delete call")
