...
public class ServicesIT extends TestBase {
    ...
    public void compareGetParamsResponseCode200Test() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.compareGetResponseCode("posts/", new Request(params), 200);
        // verify no issues
        finish();
    }
    ...
    public void compareGetParamsResponseBadCode201Test() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.compareGetResponseCode("posts/", new Request(params), 201);
        // verify one issue
        finish(1);
    }
    ...
    public void compareGetParamsResponseCode404Test() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.compareGetResponseCode("post/", new Request(params), 404);
        // verify no issues
        finish();
    }
    ...
    public void compareGetParamsResponseBadCode400Test() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.compareGetResponseCode("post/", new Request(params), 400);
        // verify one issue
        finish(1);
    }
    ...
    public void compareGetResponseObjectDataTest() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.compareGetResponseData("posts/6", response);
        // verify no issues
        finish();
    }
    ...
    public void compareGetParamsResponseObjectDataTest() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.compareGetResponseData("posts/6", new Request(params), response);
        // verify no issues
        finish();
    }
    ...
    public void compareGetParamsResponseArrayDataTest() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.compareGetResponseData("posts", new Request(params), response);
        // verify no issues
        finish();
    }
    ...
    public void comparePostResponseDataTest() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.comparePostResponseData("posts/", new Request(request), response);
        // verify no issues
        finish();
    }
    ...
    public void comparePutResponseCode200Test() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.comparePutResponseCode("posts/3", new Request(request), 200);
        // verify no issues
        finish();
    }
    ...
    public void comparePutResponseBadCode201Test() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.comparePutResponseCode("posts/3", new Request(request), 201);
        // verify one issue
        finish(1);
    }
    ...
    public void comparePutResponseCode404Test() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.comparePutResponseCode("post/", new Request(request), 404);
        // verify no issues
        finish();
    }
    ...
    public void comparePutResponseBadCode400Test() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.comparePutResponseCode("post/", new Request(request), 400);
        // verify one issue
        finish(1);
    }
    ...
    public void comparePutResponseDataTest() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.comparePutResponseData("posts/3", new Request(request), request);
        // verify no issues
        finish();
    }
    ...
    public void comparePutResponseBadDataTest() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.comparePutResponseData("posts/3", new Request(request), response);
        // verify one issue
        finish(1);
    }
    ...
    public void comparePatchResponseCode200Test() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.comparePatchResponseCode("posts/4", new Request(request), 200);
        // verify no issues
        finish();
    }
    ...
    public void comparePatchResponseBadCode201Test() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.comparePatchResponseCode("posts/4", new Request(request), 201);
        // verify one issue
        finish(1);
    }
    ...
    public void comparePatchResponseCode404Test() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.comparePatchResponseCode("post/", new Request(request), 404);
        // verify no issues
        finish();
    }
    ...
    public void comparePatchResponseDataTest() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.comparePatchResponseData("posts/4", new Request(request), request);
        // verify no issues
        finish();
    }
    ...
    public void comparePatchResponseBadDataTest() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.comparePatchResponseData("posts/4", new Request(request), response);
        // verify one issue
        finish(1);
    }
    ...
    public void compareDeleteResponseCode200Test() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.compareDeleteResponseCode("posts/5", new Request(request), 200);
        // verify no issues
        finish();
    }
    ...
    public void compareDeleteResponseBadCode201Test() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.compareDeleteResponseCode("posts/5", new Request(request), 201);
        // verify one issue
        finish(1);
    }
    ...
    public void compareDeleteResponseDataTest() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.compareDeleteResponseData("posts/5", new Request(request), new JsonObject());
        // verify no issues
        finish();
    }
    ...
    public void compareDeleteResponseBadDataTest() {
        ...
        Assert asserts = this.asserts.get();
        // perform some actions
        asserts.compareDeleteResponseData("posts/5", new Request(request), response);
        // verify one issue
        finish(1);
    }
}