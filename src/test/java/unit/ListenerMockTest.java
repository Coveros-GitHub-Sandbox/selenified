...
public class ListenerTest extends Listener {
    ...
    @Test
    @Jira(project = "HW")
    public void recordZephyrValidNoIssueTest(Method method) {
        ...
        mockServer.when(request().withMethod("POST").withPath("/jira/rest/zapi/latest/execution/addTestsToCycle"))
                .respond(response().withStatusCode(200).withBody(
                        "{\"warn\":\"The following just happened: <br/> Tests added: " +
                                ...
                                "Cycle: <strong>-</strong><br/> Not a Test: " + "<strong>-" +
                                "</strong><br/> Permission Denied: <strong>-</strong><br/>\"}"));
        mockServer.when(request().withMethod("POST").withPath("/jira/rest/zapi/latest/execution"))
                .respond(response().withStatusCode(400).withBody("{\"Invalid Project\":\"projectId  1180 is Invalid.\"}"));
        ITestResult test = new ITestResult() {
            @Override
            public int getStatus() {
                return 0;
